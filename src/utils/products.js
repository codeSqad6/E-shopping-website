...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "Enjoy fast and free delivery on all orders.",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "Your transactions are encrypted and protected.",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Secure Payment",
    subtitle: "We ensure maximum security for your payments.",
    bg: "#e2f2b2",
  },
  {
    icon: <ion-icon name="headset"></ion-icon>,
    title: "Back Guarantee",
    subtitle: "Get a full refund within 7 days if not satisfied.",
    bg: "#d6e5fb",
  },
];
